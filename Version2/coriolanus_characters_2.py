...
"""
The main difference is that here I'm not lowering the text so the model would have 
much more data to learn from so it wouldn't over fit.
"""


print('Coirolanus RNN that learns by characters v.2')
