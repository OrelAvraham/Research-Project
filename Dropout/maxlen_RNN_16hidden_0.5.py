...
"""
This is the early one between the runs (02.03.2021.05.43.29)
"""

print('Coirolanus maxlen RNN units 16 nodes in hidden layer 0.5 dropout ')
...
for epoch in range(epochs):
    ...
    for num in range(3):
        ...
        for diversity in [x / 10 for x in range(1, 21, 2)]:
